...
@Component({
  selector: 'app-pillbox-tab-component',
  standalone: true,
  imports: [
    PillboxComponent,
    NzButtonComponent,
  ...
  templateUrl: './pillbox_tab.component.html',
  styleUrl: './pillbox_tab.component.css'
})
export class Pillbox_tabComponent implements OnInit {

  calendarViewable:boolean = false

  @Input() data!:PillboxWeek
  days:string[] = []
